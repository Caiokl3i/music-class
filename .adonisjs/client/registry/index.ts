...
const routes = {
  ...
  'plan_types.index': {
    ...
    tokens: [{"old":"/api/v1/plan-types","type":0,"val":"api","end":""},{"old":"/api/v1/plan-types","type":0,"val":"v1","end":""},{"old":"/api/v1/plan-types","type":0,"val":"plan-types","end":""}],
    types: placeholder as Registry['plan_types.index']['types'],
  },
  'plan_types.store': {
    methods: ["POST"],
    pattern: '/api/v1/plan-types',
    tokens: [{"old":"/api/v1/plan-types","type":0,"val":"api","end":""},{"old":"/api/v1/plan-types","type":0,"val":"v1","end":""},{"old":"/api/v1/plan-types","type":0,"val":"plan-types","end":""}],
    types: placeholder as Registry['plan_types.store']['types'],
  },
  'plan_types.show': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/plan-types/:id',
    tokens: [{"old":"/api/v1/plan-types/:id","type":0,"val":"api","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"plan-types","end":""},{"old":"/api/v1/plan-types/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['plan_types.show']['types'],
  },
  'plan_types.update': {
    methods: ["PUT","PATCH"],
    pattern: '/api/v1/plan-types/:id',
    tokens: [{"old":"/api/v1/plan-types/:id","type":0,"val":"api","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"plan-types","end":""},{"old":"/api/v1/plan-types/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['plan_types.update']['types'],
  },
  'plan_types.destroy': {
    methods: ["DELETE"],
    pattern: '/api/v1/plan-types/:id',
    tokens: [{"old":"/api/v1/plan-types/:id","type":0,"val":"api","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/plan-types/:id","type":0,"val":"plan-types","end":""},{"old":"/api/v1/plan-types/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['plan_types.destroy']['types'],
  },
  ...
  'plans.billing': {
    ...
    tokens: [{"old":"/api/v1/plans/:id/billing","type":0,"val":"api","end":""},{"old":"/api/v1/plans/:id/billing","type":0,"val":"v1","end":""},{"old":"/api/v1/plans/:id/billing","type":0,"val":"plans","end":""},{"old":"/api/v1/plans/:id/billing","type":1,"val":"id","end":""},{"old":"/api/v1/plans/:id/billing","type":0,"val":"billing","end":""}],
    types: placeholder as Registry['plans.billing']['types'],
  },
  'plans.billing_pdf': {
    methods: ["GET","HEAD"],
    pattern: '/api/v1/plans/:id/billing.pdf',
    tokens: [{"old":"/api/v1/plans/:id/billing.pdf","type":0,"val":"api","end":""},{"old":"/api/v1/plans/:id/billing.pdf","type":0,"val":"v1","end":""},{"old":"/api/v1/plans/:id/billing.pdf","type":0,"val":"plans","end":""},{"old":"/api/v1/plans/:id/billing.pdf","type":1,"val":"id","end":""},{"old":"/api/v1/plans/:id/billing.pdf","type":0,"val":"billing.pdf","end":""}],
    types: placeholder as Registry['plans.billing_pdf']['types'],
  },
  'plan_discounts.store': {
    methods: ["POST"],
    pattern: '/api/v1/plans/:planId/discounts',
    tokens: [{"old":"/api/v1/plans/:planId/discounts","type":0,"val":"api","end":""},{"old":"/api/v1/plans/:planId/discounts","type":0,"val":"v1","end":""},{"old":"/api/v1/plans/:planId/discounts","type":0,"val":"plans","end":""},{"old":"/api/v1/plans/:planId/discounts","type":1,"val":"planId","end":""},{"old":"/api/v1/plans/:planId/discounts","type":0,"val":"discounts","end":""}],
    types: placeholder as Registry['plan_discounts.store']['types'],
  },
  'plan_discounts.update': {
    methods: ["PATCH"],
    pattern: '/api/v1/plans/:planId/discounts/:id',
    tokens: [{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"api","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"plans","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":1,"val":"planId","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"discounts","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['plan_discounts.update']['types'],
  },
  'plan_discounts.destroy': {
    methods: ["DELETE"],
    pattern: '/api/v1/plans/:planId/discounts/:id',
    tokens: [{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"api","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"v1","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"plans","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":1,"val":"planId","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":0,"val":"discounts","end":""},{"old":"/api/v1/plans/:planId/discounts/:id","type":1,"val":"id","end":""}],
    types: placeholder as Registry['plan_discounts.destroy']['types'],
  },
  'plans.index': {
    methods: ["GET","HEAD"],
